...
var BabelCompiler = (function (_CompilerBase) {
  ...
  _createClass(BabelCompiler, [{
    ...
    value: (function () {
      ...
      return function shouldCompileFile(_x, _x2) {
    ...
    value: (function () {
      ...
      return function determineDependentFiles(_x3, _x4, _x5) {
        return ref.apply(this, arguments);
      };
    })()
    ...
    value: (function () {
      ...
      return function compile(_x6, _x7, _x8) {
        return ref.apply(this, arguments);
      };
    })()
  }, {
    ...
    value: function compileSync(sourceCode, filePath, compilerContext) {
      ...
      if ('plugins' in opts) {
        var _plugins = this.attemptToPreload(opts.plugins, 'plugin');
        if (_plugins && _plugins.length === opts.plugins.length) opts.plugins = _plugins;
      }

      if ('presets' in opts) {
        var _presets = this.attemptToPreload(opts.presets, 'preset');
        if (_presets && _presets.length === opts.presets.length) opts.presets = _presets;
      }
